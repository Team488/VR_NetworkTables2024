...
def get_current_tracker_position(tracker, interval, R, s, t, verbose=False):
    ...
    xVR, yVR, zVR, rollVR, pitchVR, yawVR = tracker.collect_sample(interval=interval, verbose=verbose)
